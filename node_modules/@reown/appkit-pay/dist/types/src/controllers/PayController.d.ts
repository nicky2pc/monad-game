...
export declare const PayController: {
    ...
    getAvailableExchanges(page?: number): Promise<import("../utils/ApiUtil.js").GetExchangesResult>;
    getPayUrl(exchangeId: string, params: PayUrlParams): Promise<{
        url: string;
        sessionId: string;
    }>;
    openPayUrl(exchangeId: string, params: PayUrlParams, openInNewTab?: boolean): Promise<{
        url: string;
        sessionId: string;
    }>;
