...
export declare const StorageUtil: {
    ...
    getActiveNetworkProps(): {
        ...
        caipNetworkId: `eip155:${string}` | `eip155:${number}` | `solana:${string}` | `solana:${number}` | `polkadot:${string}` | `polkadot:${number}` | `bip122:${string}` | `bip122:${number}` | `cosmos:${string}` | `cosmos:${number}` | undefined;
    ...
    getPreferredAccountTypes(): PreferredAccountTypes | undefined;
};
