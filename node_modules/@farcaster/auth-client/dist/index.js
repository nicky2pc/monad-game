...
var build = (params) => {
  ...
  if (valid.isErr())
    return (0, import_neverthrow4.err)(valid.error);
  else {
    const siweMessage = valid.value;
    return (0, import_neverthrow4.ok)({ siweMessage, message: siweMessage.toMessage() });
  }
};
...
var parseSignInURI = (signInUri) => {
  ...
  if (!channelToken) {
    return (0, import_neverthrow5.err)(validationFail("No channel token provided"));
  }
  return (0, import_neverthrow5.ok)({ channelToken });
};
