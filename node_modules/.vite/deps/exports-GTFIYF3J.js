import {
  WalletUtil
} from "./chunk-2YYT7B67.js";
import "./chunk-FF44UITQ.js";
import {
  W3mFrameHelpers,
  W3mFrameProvider
} from "./chunk-2TSEOFIY.js";
import {
  CaipNetworksUtil,
...
var AppKitBaseClient = class {
  constructor(options) {
    ...
    this.getCaipNetwork = (chainNamespace, id) => {
      ...
      if (chainNamespace) {
        ...
        return (_d = ChainController.getRequestedCaipNetworks(chainNamespace).filter((c) => c.chainNamespace === chainNamespace)) == null ? void 0 : _d[0];
      }
  ...
  async initialize(options) {
    ...
    if (((_a = OptionsController.state.features) == null ? void 0 : _a.email) || Array.isArray((_b = OptionsController.state.features) == null ? void 0 : _b.socials) && ((_c = OptionsController.state.features) == null ? void 0 : _c.socials.length) > 0) {
...
var AppKit = class extends AppKitBaseClient {
  ...
  setupAuthConnectorListeners(provider) {
    ...
    provider.onConnect(async (user) => {
      ...
      const preferredAccountType = user.preferredAccountType || ((_a = AccountController.state.preferredAccountTypes) == null ? void 0 : _a[namespace]) || OptionsController.state.defaultAccountTypes[namespace];
      ...
      const userAccounts = (_b = user.accounts) == null ? void 0 : _b.map((account) => {
        var _a2;
        return CoreHelperUtil.createAccount(namespace, account.address, account.type || ((_a2 = AccountController.state.preferredAccountTypes) == null ? void 0 : _a2[namespace]) || OptionsController.state.defaultAccountTypes[namespace]);
      });
  ...
  createAuthProvider(chainNamespace) {
    ...
    const isEmailEnabled = ((_b = (_a = this.options) == null ? void 0 : _a.features) == null ? void 0 : _b.email) === void 0 ? ConstantsUtil2.DEFAULT_FEATURES.email : (_d = (_c = this.options) == null ? void 0 : _c.features) == null ? void 0 : _d.email;
    const isSocialsEnabled = ((_f = (_e = this.options) == null ? void 0 : _e.features) == null ? void 0 : _f.socials) ? ((_i = (_h = (_g = this.options) == null ? void 0 : _g.features) == null ? void 0 : _h.socials) == null ? void 0 : _i.length) > 0 : ((_k = (_j = this.options) == null ? void 0 : _j.features) == null ? void 0 : _k.socials) ?? ConstantsUtil2.DEFAULT_FEATURES.socials;
    const isAuthEnabled = isEmailEnabled || isSocialsEnabled;
    if (!this.authProvider && ((_l = this.options) == null ? void 0 : _l.projectId) && isAuthEnabled) {
      this.authProvider = W3mFrameProviderSingleton.getInstance({
        projectId: this.options.projectId,
        enableLogger: this.options.enableAuthLogger,
        chainId: (_m = this.getCaipNetwork(chainNamespace)) == null ? void 0 : _m.caipNetworkId,
      ...
      if (chainNamespace === ConstantsUtil.CHAIN.EVM && ((_n = AccountController.state.preferredAccountTypes) == null ? void 0 : _n.eip155)) {
        this.authProvider.setPreferredAccount((_o = AccountController.state.preferredAccountTypes) == null ? void 0 : _o.eip155);
      }
  ...
  async switchCaipNetwork(caipNetwork) {
    ...
    if (caipNetwork.chainNamespace === ChainController.state.activeChain && namespaceAddress) {
      ...
      if (
        ...
        (isCurrentNamespaceAuthProvider || isNewNamespaceAuthProvider) && isNewNamespaceSupportsAuthConnector
      ) {
        try {
    ...
    if (!isInitialized && CoreHelperUtil.isClient()) {
      ...
      if (features) {
        ...
        if (usingEmbeddedWallet) {
          featureImportPromises.push(import("./embedded-wallet-QLJPWGWG.js"));
        }
        if (features.email) {
          featureImportPromises.push(import("./email-TR62G3ZX.js"));
        }
        if (features.socials) {
          featureImportPromises.push(import("./socials-BYCFJ75R.js"));
        }
        if (features.swaps) {
          featureImportPromises.push(import("./swaps-QLHFA4GH.js"));
        }
        if (features.send) {
          featureImportPromises.push(import("./send-YSCFOAFK.js"));
        }
        if (features.receive) {
          featureImportPromises.push(import("./receive-GEM4JS35.js"));
        }
        if (features.onramp) {
          featureImportPromises.push(import("./onramp-FWWCEFJ6.js"));
        }
        if (features.history) {
          featureImportPromises.push(import("./transactions-XT6NYI62.js"));
        }
        if (features.pay) {
          featureImportPromises.push(import("./exports-NMQNRCRO.js"));
        }
      }
      await Promise.all([
        ...featureImportPromises,
        import("./exports-7PQYJOQE.js"),
        import("./w3m-modal-ENCIXSZO.js")
      ]);
...
//# sourceMappingURL=exports-GTFIYF3J.js.map
