    ...
    if (!isInitialized && CoreHelperUtil.isClient()) {
      ...
      if (features) {
        ...
        if (usingEmbeddedWallet) {
          featureImportPromises.push(import("./embedded-wallet-EF4ZERJH.js"));
        }
        if (features.email) {
          featureImportPromises.push(import("./email-MVNGUNLM.js"));
        }
        if (features.socials) {
          featureImportPromises.push(import("./socials-XUI57JYI.js"));
        }
        if (features.swaps) {
          featureImportPromises.push(import("./swaps-6MHHZ2AI.js"));
        }
        if (features.send) {
          featureImportPromises.push(import("./send-YSFME65O.js"));
        }
        if (features.receive) {
          featureImportPromises.push(import("./receive-HDKR2G77.js"));
        }
        if (features.onramp) {
          featureImportPromises.push(import("./onramp-LNIN55GA.js"));
        }
        if (features.history) {
          featureImportPromises.push(import("./transactions-ZDREL7FS.js"));
        }
        if (features.pay) {
          featureImportPromises.push(import("./exports-VNY6BZLO.js"));
        }
      }
      await Promise.all([
        ...featureImportPromises,
        import("./exports-DBMJRFOP.js"),
        import("./w3m-modal-TEXX63E2.js")
      ]);
...
//# sourceMappingURL=exports-TOPBVDOF.js.map
