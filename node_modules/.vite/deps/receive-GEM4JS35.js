import "./chunk-Y64JRJTG.js";
import "./chunk-UBYQ3S7L.js";
...
var W3mWalletReceiveView = class W3mWalletReceiveView2 extends LitElement {
  ...
  networkTemplate() {
    ...
    if (((_a = this.preferredAccountTypes) == null ? void 0 : _a[caipNetwork == null ? void 0 : caipNetwork.chainNamespace]) === W3mFrameRpcConstants.ACCOUNT_TYPES.SMART_ACCOUNT && isNetworkEnabledForSmartAccounts) {
      if (!caipNetwork) {
        return null;
      }
    ...
    const slicedNetworks = (_b = namespaceNetworks == null ? void 0 : namespaceNetworks.filter((network) => {
      var _a2;
      return (_a2 = network == null ? void 0 : network.assets) == null ? void 0 : _a2.imageId;
    })) == null ? void 0 : _b.slice(0, 5);
...
//# sourceMappingURL=receive-GEM4JS35.js.map
