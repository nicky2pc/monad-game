import {
  W3mRouter
} from "./chunk-YHWZKHCW.js";
import {
  ConnectorUtil,
  WalletUtil
} from "./chunk-ZGEECBQK.js";
import "./chunk-EUFYJ2WK.js";
import {
  executeSocialLogin
} from "./chunk-FHAKSZWI.js";
import {
...
import "./chunk-I2CUX63H.js";
import "./chunk-4APMK2DA.js";
import "./chunk-WP2APS2Y.js";
import "./chunk-CKGS2HVH.js";
import "./chunk-OSYXBGXW.js";
import "./chunk-DW2FONXD.js";
import "./chunk-HNB35IZC.js";
import "./chunk-6HQCADWA.js";
import "./chunk-RK6MNKTC.js";
import "./chunk-N2QVPMLO.js";
import "./chunk-6Y2CFVFN.js";
import {
  networkSvgMd
} from "./chunk-MSI6GSQN.js";
import {
  ConstantsUtil as ConstantsUtil3
} from "./chunk-AYS3JYHL.js";
import "./chunk-GJP6XNCB.js";
import "./chunk-5GHLGCVU.js";
import "./chunk-Y26NY4JM.js";
import "./chunk-SDIZ2BGS.js";
import "./chunk-PHT5LVMY.js";
...
var W3mAccountSettingsView = class W3mAccountSettingsView2 extends LitElement {
  ...
  togglePreferredAccountBtnTemplate() {
    ...
    if (!this.switched) {
      this.text = ((_b = this.preferredAccountTypes) == null ? void 0 : _b[namespace]) === W3mFrameRpcConstants.ACCOUNT_TYPES.SMART_ACCOUNT ? "Switch to your EOA" : "Switch to your smart account";
    }
    return html`
      <wui-list-item
        variant="icon"
  ...
  async changePreferredAccountType() {
    ...
    const accountTypeTarget = ((_b = this.preferredAccountTypes) == null ? void 0 : _b[namespace]) === W3mFrameRpcConstants.ACCOUNT_TYPES.SMART_ACCOUNT || !isSmartAccountEnabled ? W3mFrameRpcConstants.ACCOUNT_TYPES.EOA : W3mFrameRpcConstants.ACCOUNT_TYPES.SMART_ACCOUNT;
    const authConnector = ConnectorController.getAuthConnector();
    if (!authConnector) {
      return;
    }
...
var W3mAccountDefaultWidget = class W3mAccountDefaultWidget2 extends LitElement {
  ...
  onrampTemplate() {
    ...
    const isOnrampEnabled = (_a = this.features) == null ? void 0 : _a.onramp;
  ...
  swapsTemplate() {
    var _a;
    const isSwapsEnabled = (_a = this.features) == null ? void 0 : _a.swaps;
...
WuiProfileButton.styles = [resetStyles, elementStyles, styles_default11];
__decorate15([
  property()
    ...
    if (((_a = this.network) == null ? void 0 : _a.caipNetworkId) && !ConstantsUtil2.SWAP_SUPPORTED_NETWORKS.includes((_b = this.network) == null ? void 0 : _b.caipNetworkId)) {
      ...
      EventsController.sendEvent({
        ...
        properties: {
          ...
          isSmartAccount: ((_d = AccountController.state.preferredAccountTypes) == null ? void 0 : _d[activeChainNamespace]) === W3mFrameRpcConstants.ACCOUNT_TYPES.SMART_ACCOUNT
        }
      });
      RouterController.push("Swap");
    }
...
WuiListAccount.styles = [resetStyles, elementStyles, styles_default18];
__decorate23([
  property()
...
var W3mProfileView = class W3mProfileView2 extends LitElement {
  ...
  async onSwitchAccount(account) {
    var _a;
    const namespace = (_a = ChainController.state.activeCaipNetwork) == null ? void 0 : _a.chainNamespace;
    this.loading = true;
...
W3mProfileView.styles = styles_default19;
__decorate24([
  state()
...
WuiBannerImg.styles = [resetStyles, elementStyles, styles_default20];
__decorate25([
  property()
...
W3mSwitchAddressView.styles = styles_default21;
__decorate26([
  state()
...
W3mSwitchAddressView = __decorate26([
...
WuiSwitch.styles = [resetStyles, elementStyles, colorStyles, styles_default22];
__decorate27([
  property({ type: Boolean })
...
WuiCertifiedSwitch.styles = [resetStyles, elementStyles, styles_default23];
__decorate28([
  property({ type: Boolean })
...
WuiInputElement.styles = [resetStyles, elementStyles, styles_default24];
__decorate29([
  property()
...
WuiSearchBar.styles = [resetStyles, styles_default25];
...
WuiCardSelectLoader.styles = [resetStyles, elementStyles, styles_default26];
__decorate31([
  property()
...
WuiGrid.styles = [resetStyles, styles_default27];
__decorate32([
  property()
...
W3mAllWalletsListItem.styles = styles_default28;
__decorate33([
  state()
...
W3mAllWalletsList.styles = styles_default29;
__decorate34([
  state()
...
W3mAllWalletsSearch.styles = styles_default30;
__decorate35([
  state()
...
WuiListButton.styles = [resetStyles, elementStyles, styles_default31];
__decorate37([
  property()
...
W3mEmailLoginWidget.styles = styles_default32;
__decorate38([
  property()
...
W3mEmailLoginWidget = __decorate38([
...
WuiLogoSelect.styles = [resetStyles, elementStyles, styles_default33];
__decorate39([
  property()
...
W3mSocialLoginWidget.styles = styles_default34;
__decorate40([
  property()
...
W3mSocialLoginWidget = __decorate40([
...
W3mWalletGuide.styles = styles_default35;
__decorate41([
  property()
...
WuiAllWalletsImage.styles = [resetStyles, styles_default36];
__decorate42([
  property({ type: Array })
], WuiAllWalletsImage.prototype, "walletImages", void 0);
WuiAllWalletsImage = __decorate42([
...
W3mAllWalletsWidget = __decorate44([
...
W3mConnectAnnouncedWidget = __decorate45([
...
W3mConnectCustomWidget = __decorate46([
...
W3mConnectExternalWidget = __decorate47([
...
W3mConnectFeaturedWidget = __decorate48([
...
W3mConnectInjectedWidget = __decorate49([
...
W3mConnectMultiChainWidget = __decorate50([
...
W3mConnectRecentWidget = __decorate51([
...
W3mConnectRecommendedWidget = __decorate52([
...
W3mConnectWalletConnectWidget = __decorate53([
...
W3mConnectorList.styles = styles_default38;
__decorate54([
  property()
...
W3mWalletLoginList = __decorate55([
...
W3mConnectView.styles = styles_default39;
__decorate56([
  state()
...
WuiCtaButton.styles = [resetStyles, elementStyles, styles_default40];
__decorate57([
  property({ type: Boolean })
...
W3mMobileDownloadLinks.styles = [styles_default41];
__decorate58([
  property({ type: Object })
], W3mMobileDownloadLinks.prototype, "wallet", void 0);
W3mMobileDownloadLinks = __decorate58([
...
W3mConnectingWidget.styles = styles_default42;
__decorate59([
  state()
...
W3mConnectingExternalView = __decorate60([
...
W3mConnectingMultiChainView.styles = styles_default43;
__decorate61([
  state()
], W3mConnectingMultiChainView.prototype, "activeConnector", void 0);
W3mConnectingMultiChainView = __decorate61([
...
W3mConnectingHeader = __decorate62([
...
W3mConnectingWcBrowser = __decorate63([
...
W3mConnectingWcDesktop = __decorate64([
...
W3mConnectingWcMobile = __decorate65([
...
W3mConnectingWcQrcode.styles = styles_default44;
W3mConnectingWcQrcode = __decorate66([
...
W3mConnectingWcUnsupported = __decorate67([
...
W3mConnectingWcWeb = __decorate68([
...
W3mConnectingWcView = __decorate69([
...
W3mConnectingWcBasicView = __decorate70([
...
W3mChooseAccountNameView.styles = styles_default45;
__decorate71([
  state()
], W3mChooseAccountNameView.prototype, "loading", void 0);
W3mChooseAccountNameView = __decorate71([
...
W3mWhatIsAWalletView = __decorate75([
...
W3mConnectWalletsView.styles = styles_default46;
__decorate76([
  state()
], W3mConnectWalletsView.prototype, "checked", void 0);
W3mConnectWalletsView = __decorate76([
...
WuiLoadingHexagon.styles = [resetStyles, styles_default47];
WuiLoadingHexagon = __decorate77([
...
W3mNetworkSwitchView.styles = styles_default48;
__decorate78([
  state()
...
W3mNetworkSwitchView = __decorate78([
...
WuiListNetwork.styles = [resetStyles, elementStyles, styles_default49];
__decorate79([
  property()
...
W3mNetworksView.styles = styles_default50;
__decorate80([
  state()
...
W3mSwitchActiveChainView.styles = styles_default51;
__decorate81([
  property()
], W3mSwitchActiveChainView.prototype, "activeChain", void 0);
W3mSwitchActiveChainView = __decorate81([
...
W3mWhatIsANetworkView = __decorate82([
...
W3mUnsupportedChainView.styles = styles_default52;
__decorate83([
  state()
], W3mUnsupportedChainView.prototype, "disconecting", void 0);
W3mUnsupportedChainView = __decorate83([
...
WuiBanner.styles = [resetStyles, elementStyles, styles_default53];
__decorate84([
  property()
...
var W3mWalletCompatibleNetworksView = class W3mWalletCompatibleNetworksView2 extends LitElement {
  ...
  networkTemplate() {
    ...
    if (isNetworkEnabledForSmartAccounts && ((_a = this.preferredAccountTypes) == null ? void 0 : _a[caipNetwork == null ? void 0 : caipNetwork.chainNamespace]) === W3mFrameRpcConstants.ACCOUNT_TYPES.SMART_ACCOUNT) {
      if (!caipNetwork) {
        return null;
      }
...
W3mWalletCompatibleNetworksView.styles = styles_default54;
__decorate85([
  state()
], W3mWalletCompatibleNetworksView.prototype, "preferredAccountTypes", void 0);
W3mWalletCompatibleNetworksView = __decorate85([
...
WuiVisualThumbnail.styles = [resetStyles, styles_default55];
__decorate86([
  property()
...
WuiVisualThumbnail = __decorate86([
...
W3mSIWXSignMessageThumbnails.styles = styles_default56;
W3mSIWXSignMessageThumbnails = __decorate87([
...
W3mSIWXSignMessageView = __decorate88([
...
//# sourceMappingURL=exports-DBMJRFOP.js.map
